...
contract DeployInvalidlessFlatCFMFactory is Script {
    function run() external {
        ...
        // Deploy.
        InvalidlessFlatCFMFactory factory = new InvalidlessFlatCFMFactory(conditionalTokens, wrapped1155Factory);
        console.log("InvalidlessFlatCFMFactory deployed at:", address(factory));
